      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0f0a05] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-serif text-5xl font-bold text-white leading-tight mb-8">
            Fashion is the<br />
            armour to<br />
            <span className="italic text-amber-400">survive everyday</span><br />
            life.
          </h2>
        ...
        <div className="relative z-10">
          <p className="text-white/20 text-xs">
            Trusted by 50,000+ customers in 60+ countries.
          </p>
        </div>
      </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col gap-1">
                      {passwordRules.map((rule) => (
                        <div key={rule.label} className="flex items-center gap-1.5">
                          ...
                          <span className={`text-[10px] ${rule.test(form.password) ? "text-green-600" : "text-[#8a7060]"}`}>
                            {rule.label}
                          </span>
                        </div>
                      ))}
                    ...
                    {strengthLabel && (
                      <span className={`text-xs font-bold ${
                        ...
                        passwordStrength === 2 ? "text-amber-600" : "text-red-500"
                      }`}>
                        {strengthLabel}
                      </span>
                    )}
