...
const allProducts = [
  { id: "d84a87ef-3c86-4c03-a36f-1139dd2007c1", name: "Boys Navy Suit", category: "Boys", price: 85.00, originalPrice: 110.00, rating: 4.9, reviews: 143, isNew: true, isSale: true, bg: "#1a2848", image: "/suits/kids/boys-navy.jpg" },
  { id: "d83a4253-b058-46ad-9c56-7a74f92598c2", name: "Girls Blazer Set", category: "Girls", price: 72.00, originalPrice: null, rating: 4.8, reviews: 98, isNew: true, isSale: false, bg: "#e8d5d8", image: "/suits/kids/girls-blazer.jpg" },
  { id: "8fcb0df7-ec9a-4225-ab8e-5ebdd5bf3880", name: "Mini Tuxedo", category: "Formal", price: 95.00, originalPrice: 120.00, rating: 4.7, reviews: 76, isNew: false, isSale: true, bg: "#1a1a28", image: "/suits/kids/mini-tux.jpg" },
  { id: "15782252-4eae-4917-bea9-a0af1db30bcd", name: "Boys Linen Suit", category: "Smart Casual", price: 68.00, originalPrice: null, rating: 4.6, reviews: 187, isNew: false, isSale: false, bg: "#e8ddd5", image: "/suits/kids/linen-suit.jpg" },
  { id: "9f151d17-ca46-4b4f-bb81-27ea84ba64ff", name: "Girls Formal Dress Suit", category: "Girls", price: 78.00, originalPrice: 98.00, rating: 4.9, reviews: 112, isNew: true, isSale: true, bg: "#d5d8e8", image: "/suits/kids/girls-formal.jpg" },
  { id: "655e873b-e96b-425f-931a-da4715302489", name: "Check Smart Blazer", category: "Smart Casual", price: 62.00, originalPrice: null, rating: 4.7, reviews: 134, isNew: true, isSale: false, bg: "#b8b8c8", image: "/suits/kids/check-blazer.jpg" },
];

const categories  = ["All", "Boys", "Girls", "Formal", "Smart Casual"];
const sortOptions = ["Featured", "Price: Low to High", "Price: High to Low", "Newest", "Best Rated"];

export default function SuitsKidsPage() {
  ...
  const handleAddToCart = async (productId: string) => {
    ...
    if (!session) { router.push("/account/login?redirect=/shop/suits/kids"); return; }
    ...
    <>
      ...
      <section className="relative w-full h-64 sm:h-80 bg-[#0a0a14] overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
          <p className="text-xs uppercase tracking-[0.3em] text-indigo-300 font-semibold mb-3">Little Gentlemen & Ladies</p>
          <h1 className="font-serif text-5xl sm:text-6xl font-bold text-white mb-3">Kids' Suits</h1>
