...
const allProducts = [
  { id: "2708aea0-c2dc-49bd-8b8e-d1426a7271bd", name: "White Power Suit", category: "Formal", price: 310.00, originalPrice: 390.00, rating: 4.9, reviews: 178, isNew: true, isSale: true, bg: "#e8e8e0", image: "/suits/womens/white-suit.jpg" },
  { id: "ca6a97b7-f972-4607-904e-e5c87c931625", name: "Navy Blazer Set", category: "Blazer Set", price: 265.00, originalPrice: null, rating: 4.8, reviews: 134, isNew: true, isSale: false, bg: "#1a2848", image: "/suits/womens/navy-blazer.jpg" },
  { id: "6639403d-36f9-4257-9408-58b83ece6a7c", name: "Camel Slim Suit", category: "Slim Fit", price: 290.00, originalPrice: 360.00, rating: 4.7, reviews: 92, isNew: false, isSale: true, bg: "#c8a878", image: "/suits/womens/camel-suit.jpg" },
  { id: "a03809a7-1706-40e1-954d-334c444cfdac", name: "Checked Blazer Set", category: "Blazer Set", price: 245.00, originalPrice: null, rating: 4.6, reviews: 203, isNew: false, isSale: false, bg: "#7878a8", image: "/suits/womens/check-blazer.jpg" },
  { id: "12beed6c-08a8-4c9c-b2c1-e3593dfbe8d6", name: "Black Evening Suit", category: "Formal", price: 380.00, originalPrice: 480.00, rating: 4.9, reviews: 67, isNew: true, isSale: true, bg: "#1a1a28", image: "/suits/womens/black-suit.jpg" },
  { id: "c4ac2846-5bb9-4bc6-95da-8f3bd31402c5", name: "Pastel Linen Suit", category: "Casual", price: 220.00, originalPrice: null, rating: 4.7, reviews: 156, isNew: true, isSale: false, bg: "#dde8d5", image: "/suits/womens/linen-suit.jpg" },
];

const categories  = ["All", "Blazer Set", "Slim Fit", "Casual", "Formal"];
const sortOptions = ["Featured", "Price: Low to High", "Price: High to Low", "Newest", "Best Rated"];

export default function SuitsWomensPage() {
  ...
  const handleAddToCart = async (productId: string) => {
    ...
    if (!session) { router.push("/account/login?redirect=/shop/suits/womens"); return; }
    ...
    <>
      ...
      <section className="relative w-full h-64 sm:h-80 bg-[#0a0a14] overflow-hidden flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
          ...
          <h1 className="font-serif text-5xl sm:text-6xl font-bold text-white mb-3">Women's Suits</h1>
