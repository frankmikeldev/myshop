...
const product = {
  ...
  isSale: false,
  description:
    "Effortlessly relaxed yet polished, our Linen Trousers are your warm-weather essential. Cut from a premium linen blend that gets softer with every wash, they feature a high-rise waist, wide-leg silhouette and a subtle pleat front for a refined, editorial feel. Dress them up with a silk blouse or keep it casual with a simple tee — they do both beautifully.",
  features: [
    "55% linen, 45% viscose blend",
    "High-rise wide-leg silhouette",
    "Pleat front with side zip closure",
    "Two side slash pockets",
    "Relaxed drape fabric — gets softer with wear",
    "Dry clean or cool hand wash",
  ],
  sizes: ["XS", "S", "M", "L", "XL"],
  colors: [
    { name: "Natural Oat",   hex: "#d8c8a8" },
    { name: "Sage Green",    hex: "#8a9880" },
    { name: "Dusty Rose",    hex: "#c8a0a0" },
    { name: "Ecru White",    hex: "#f0ece0" },
  ],
  images: [
    "/products/trousers-1.jpg",
    "/products/trousers-2.jpg",
    "/products/trousers-3.jpg",
    "/products/trousers-4.jpg",
  ],
  bg: "#e8ddd5",
};
...
const relatedProducts = [
  { id: "r1",  name: "Linen Blazer",              slug: "linen-blazer",          price: 128.00, originalPrice: 158.00, rating: 4.8, reviews: 94,  isSale: true,  bg: "#d8c8a8", image: "/related/linen-blazer.jpg" },
  { id: "r2",  name: "Broderie Anglaise Top",     slug: "broderie-top",          price: 55.00,  originalPrice: null,   rating: 4.6, reviews: 118, isSale: false, bg: "#f0ece8", image: "/related/broderie-top.jpg" },
  { id: "r3",  name: "Wrap Midi Skirt",           slug: "wrap-midi-skirt",       price: 72.00,  originalPrice: 90.00,  rating: 4.7, reviews: 143, isSale: true,  bg: "#e8d8c8", image: "/related/wrap-midi.jpg" },
  { id: "r4",  name: "Relaxed Linen Shirt",       slug: "relaxed-linen-shirt",   price: 68.00,  originalPrice: null,   rating: 4.7, reviews: 201, isSale: false, bg: "#e0d8c8", image: "/related/linen-shirt.jpg" },
  { id: "r5",  name: "Strappy Slip Cami",         slug: "slip-cami",             price: 38.00,  originalPrice: 48.00,  rating: 4.5, reviews: 167, isSale: true,  bg: "#e8e0d0", image: "/related/slip-cami.jpg" },
  { id: "r6",  name: "Wide Brim Raffia Hat",      slug: "raffia-hat",            price: 45.00,  originalPrice: null,   rating: 4.6, reviews: 88,  isSale: false, bg: "#d0c098", image: "/related/raffia-hat.jpg" },
  { id: "r7",  name: "Cropped Knit Vest",         slug: "cropped-knit-vest",     price: 62.00,  originalPrice: 78.00,  rating: 4.8, reviews: 112, isSale: true,  bg: "#e8e8d8", image: "/related/knit-vest.jpg" },
  { id: "r8",  name: "Tailored Shorts",           slug: "tailored-shorts",       price: 58.00,  originalPrice: null,   rating: 4.5, reviews: 76,  isSale: false, bg: "#d8d0c0", image: "/related/tailored-shorts.jpg" },
  { id: "r9",  name: "Smock Maxi Dress",          slug: "smock-maxi",            price: 105.00, originalPrice: 130.00, rating: 4.9, reviews: 189, isSale: true,  bg: "#e8d8e0", image: "/related/smock-maxi.jpg" },
  { id: "r10", name: "Woven Leather Sandals",     slug: "woven-sandals",         price: 82.00,  originalPrice: null,   rating: 4.7, reviews: 134, isSale: false, bg: "#c8a878", image: "/related/woven-sandals.jpg" },
];

export default function LinenTrousersPage() {
